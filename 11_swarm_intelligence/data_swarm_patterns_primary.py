...
class DataSwarmEngine:
    ...
    def _replicate_packet(self, packet: DataPacket):
        ...
        available_peers = list(set(self.peer_nodes.keys()) - self.replica_registry[packet.packet_id])
    ...
    def add_peer_node(self, peer_id: str, role: SwarmNodeRole = SwarmNodeRole.OBSERVER, capacity: NodeCapacity = None):
        if capacity is None:
            base_capacity = self._get_initial_capacity()
...
if __name__ == "__main__":
    ...
    def test_adaptive_parameters(node1):
        ...
        for i in range(20):
            ...
            simulated_latency = random.uniform(5.0, 50.0) + (i * 0.5)  # Gradually increasing
